...
class fakeSuccessfullCarRepository: CarRepository {
    ...
    func createCar(vehicle: Car) -> Bool {
        ...
        if vehicle.getDayIn() != 0 {
        
            return false
        
        }
        
        if vehicle.getHourIn() != 0 {
    ...
    func getCars() -> [Car] {
        ...
        let car1 = Car(day: 36, hour: 15, plate: "FBS-059")
        let car2 = Car(day: 23, hour: 15, plate: "GHS-284")
    ...
    func getCarByPlate(carPlate: String) -> Car? {
        ...
        var car = Car(day: 0, hour: 0, plate: "")
        
        if carPlate == "GHS-284" {
            car = Car(day: 36, hour: 15, plate: carPlate)
        }
