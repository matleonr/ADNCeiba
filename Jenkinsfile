  ...
  stages{
    ...
    stage('Unit Tests') {
      steps{
        ...
        sh 'xcodebuild -scheme "Presentation" -configuration "Debug" build test -destination "platform=iOS Simulator,name=iPhone 6,OS=10.1" -enableCodeCoverage YES | /usr/local/bin/xcpretty -r junit'
